  ...
  blocks: [
    ...
    },
    {
      ...
      articles: [
        {
          category: 'Belleza',
          title: 'Los mejores shampoos en Argentina para crecer el pelo (y tenerlo bonito SIEMPRE)',
          imageAlt: 'Editorial de shampoos para cabello',
          imageTone: 'warm',
          imageSrc: imageMap.belleza.cabelloCarrusel[0],
        },
        {
          category: 'Belleza',
          title: 'Cómo lavarse el cabello como las brasileras, para oxigenar el cuero cabelludo y unos rizos saludables',
          imageAlt: 'Editorial de cabello y rizos saludables',
          imageTone: 'rose',
          imageSrc: imageMap.belleza.cabelloCarrusel[1],
        },
        {
          category: 'Belleza',
          title: 'Belinda y Danna: Apoyan a México y muestran los peinados para cabello lacio y rizado que son tendencia en verano 2026',
          imageAlt: 'Belinda y Danna con peinados de tendencia',
          imageTone: 'dark',
          imageSrc: imageMap.belleza.cabelloCarrusel[2],
        },
        {
          category: 'Belleza',
          title: 'Azul Guaita nos comparte sus secretos de belleza para cuidar tu cabello y lograr un look natural',
          imageAlt: 'Azul Guaita con cabello natural',
          imageTone: 'ivory',
          imageSrc: imageMap.belleza.cabelloCarrusel[3],
        },
      ],
    },
    {
